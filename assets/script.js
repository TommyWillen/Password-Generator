...
function generatePassword() {
  ...
  if (
    ...
    var newPassword =
      ...
      passString.pick(confirmPasslength - 4);
    ...
    var newPassword =
      ...
      passChars.lowers.pick(1) +
      passChars.numbers.pick(1) +
      passString.pick(confirmPasslength - 3);
    ...
    var newPassword =
      passChars.uppers.pick(1) +
      passChars.lowers.pick(1) +
      passString.pick(confirmPasslength - 2);
    ...
    var newPassword = passString.pick(confirmPasslength);
  }
